...
export default function CreateUrlForm() {
    ...
    return (
        <form
            ...
            className="w-full max-w-md flex flex-col gap-8 px-10 py-14 bg-gray-50 dark:bg-gray-800 rounded-3xl shadow-lg shadow-gray-400/20 dark:shadow-black/30"
        >
            ...
            <Button
                type="submit"
                className="mt-6 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-400 hover:scale-105 transition-transform"
            >
                Create URL
            </Button>
        </form>
